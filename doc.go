...
capnpc-go provides the compiler backend for capnp.
	...
	go install github.com/lvdlvd/go-capnproto2/capnpc-go
...
detect when two types are in the same package.  For example:
	...
	using Go = import "github.com/lvdlvd/go-capnproto2/go.capnp";
	$Go.package("main");
	$Go.import("github.com/lvdlvd/go-capnproto2/example");
...
*/
package capnp // import "github.com/lvdlvd/go-capnproto2"
